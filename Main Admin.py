...
def show_full_message(event):
    ...
    #Create a frame for attachment
    attachment_frame = tk.Frame(message_body_frame)
    attachment_frame.pack(fill=tk.BOTH, expand=True, padx=10, pady=(0, 10))
...
full_message_attachment_frame = tk.Frame(lower_frame)
full_message_attachment_frame.pack(side=tk.RIGHT, fill=tk.BOTH, expand=True, padx=10, pady=10)
